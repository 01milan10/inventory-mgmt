...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <form class="form-horizontal form-material" action="{{route('items.update',['item'=>$item->id])}}" method="post">
                @csrf()
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12 m-b-20 @error('name') is-invalid @enderror">
                                <input type="number" class="form-control" name="rate" placeholder="Rate" value="{{$item->rate}}">
                                @error('rate')
                                <div class="invalid-feedback">
                                    <span>{{$message}}</span>
                                </div>
                            ...
                            <div class="col-md-12 m-b-20 @error('name') is-invalid @enderror">
                                <input type="date" class="form-control" name="date" placeholder="Added Date" value="{{$item->added_date}}">
                                @error('date')
                                <div class="invalid-feedback">
                                    <span>{{$message}}</span>
                                </div>
